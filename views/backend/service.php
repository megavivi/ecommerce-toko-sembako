...
function ubahservice() {
    ...
    $.ajax({
        ...
        url: '<?=base_url();?>plugin/editService/'+idkurir,
        success: function() {
        ...
        <div class="modal-content">
            <form action="<?=base_url('plugin/addService');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-success btn-flat" id="btn-ubah" onclick="ubahservice()">Edit</button>
                </div>
            </form>
        </div>
    </div>
