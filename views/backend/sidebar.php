...
<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?=isset($laporan) ? ' active':'';?>">
            ...
            <ul class="treeview-menu">
                <li <?=isset($allproduct) ? 'class="active"':'';?>><a href="<?=site_url('report');?>"><i
                            class="fa fa-angle-double-right"></i> Penjualan</a></li>
                <li <?=isset($addproduct) ? 'class="active"':'';?>><a href="<?=site_url('reportstok');?>"><i
        ...
        <li class="treeview <?=isset($plugin) ? 'active':'';?>">
            ...
            <ul class="treeview-menu">
                ...
                <li <?=isset($ongkir) ? 'class="active"':'';?>><a href="<?=site_url('plugin/ongkir');?>"><i
                            class="fa fa-angle-double-right"></i> Shipping Costs</a>
                </li>
