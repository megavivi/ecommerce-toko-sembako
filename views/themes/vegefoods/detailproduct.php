    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate" style="overflow:scroll; height:400px;">
                <?php
                if(empty(produk_gambar(decrypt_url($produk->idproduct)))):
                ?>
                <a href="<?=base_url().'uploads/products/'.$produk->product_image;?>" class="image-popup"><img
                        src="<?=base_url().'uploads/products/'.$produk->product_image;?>" class="img-fluid" alt="<?=$produk->product_name;?>"
                        style="border:1px solid;margin-bottom:5px;width:150px;height:135px;"></a>
                <?php
                else :
                    ?>
                    <?php foreach(produk_gambar($produk->idproduct) as $img):?>
